...
def load_data(data_type:str, dir_path:str, out_path:str, in_length:int, out_length:int, batch_size:int):
    '''
    Load the targeted data as a list of tuples (<train_matrix>, <result_matrix>)
    <train_matrix> shape [batch_size, in_length, dim=2]
    <result_matrix> shape [batch_size, out_length, dim=2]
    '''
...
load_data('train', 'D:\\AI\\Python\\.vscode\\LSTM\\datasets\\eth\\train', 'LSTM/data', 7, 7, 128)